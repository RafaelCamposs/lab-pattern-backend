...
class OpenAiPromptConfig(
    ...
    private val challengePrompt by lazy { promptLoader.loadPrompt("challenge-generation") }
    private val evaluationPrompt by lazy { promptLoader.loadPrompt("submission-evaluation") }
